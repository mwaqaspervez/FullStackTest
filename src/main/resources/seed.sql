...
time_to_reach_destination_in_seconds) VALUES (1, 2, 0,DATEADD('ss',2100, CURRENT_TIMESTAMP),50,5,0,0);

INSERT INTO delivery_details (id, customer_type,delivery_status,expected_delivery_time,
current_distance_from_destination_in_meters,rider_rating,mean_time_to_prepare_food_in_seconds,
time_to_reach_destination_in_seconds) VALUES (2, 1, 2,DATEADD('ss',3300, CURRENT_TIMESTAMP),10,4,1800,1500);

INSERT INTO delivery_details (id, customer_type,delivery_status,expected_delivery_time,
current_distance_from_destination_in_meters,rider_rating,mean_time_to_prepare_food_in_seconds,
time_to_reach_destination_in_seconds) VALUES (3, 0, 3,DATEADD('ss',3300, CURRENT_TIMESTAMP),40,3,0,0);

INSERT INTO delivery_details (id, customer_type,delivery_status,expected_delivery_time,
current_distance_from_destination_in_meters,rider_rating,mean_time_to_prepare_food_in_seconds,
time_to_reach_destination_in_seconds) VALUES (4, 2, 1,DATEADD('ss',5100, CURRENT_TIMESTAMP),0,2,3600,1500);

INSERT INTO delivery_details (id, customer_type,delivery_status,expected_delivery_time,
current_distance_from_destination_in_meters,rider_rating,mean_time_to_prepare_food_in_seconds,
time_to_reach_destination_in_seconds) VALUES (5, 2, 2,DATEADD('ss',3980, CURRENT_TIMESTAMP),500,1,2600,1380);

INSERT INTO delivery_details (id, customer_type,delivery_status,expected_delivery_time,
current_distance_from_destination_in_meters,rider_rating,mean_time_to_prepare_food_in_seconds,
time_to_reach_destination_in_seconds) VALUES (6, 0, 3,DATEADD('ss',3980, CURRENT_TIMESTAMP),100,4,1500,2390);

INSERT INTO delivery_details (id, customer_type,delivery_status,expected_delivery_time,
current_distance_from_destination_in_meters,rider_rating,mean_time_to_prepare_food_in_seconds,
time_to_reach_destination_in_seconds) VALUES (7, 2, 1,DATEADD('ss',6700, CURRENT_TIMESTAMP),65,2,1200,5000);
